...
export default function Dashboard() {
  ...
  return (
    <PageTemplate>
      ...
      <ChartContainer>
        <DashboardTitle>
          Orders Records Analytics for {new Date().getFullYear()}
        </DashboardTitle>
        ...
        <Dropdown>
          ...
          <Dropdown.Menu>
            ...
            <Dropdown.Item onClick={() => setSelectedMonth(2)}>
              Feb
            </Dropdown.Item>
            <Dropdown.Item onClick={() => setSelectedMonth(3)}>
              March
            </Dropdown.Item>
            <Dropdown.Item onClick={() => setSelectedMonth(4)}>
              Apr
            </Dropdown.Item>
            <Dropdown.Item onClick={() => setSelectedMonth(5)}>
              May
            </Dropdown.Item>
            <Dropdown.Item onClick={() => setSelectedMonth(6)}>
              Jun
            </Dropdown.Item>
            <Dropdown.Item onClick={() => setSelectedMonth(7)}>
              July
            </Dropdown.Item>
            <Dropdown.Item onClick={() => setSelectedMonth(8)}>
              Aug
            </Dropdown.Item>
            <Dropdown.Item onClick={() => setSelectedMonth(9)}>
              Sept
            </Dropdown.Item>
            <Dropdown.Item onClick={() => setSelectedMonth(10)}>
              Oct
            </Dropdown.Item>
            <Dropdown.Item onClick={() => setSelectedMonth(11)}>
              Nov
            </Dropdown.Item>
            <Dropdown.Item onClick={() => setSelectedMonth(12)}>
              Dec
            </Dropdown.Item>
          </Dropdown.Menu>
        </Dropdown>
        ...
        <CardsSection>
          <CardContainer>
            <Card>
              ...
              <Card.Body>{"$" + totalRevenue}</Card.Body>
            </Card>
          </CardContainer>
          <CardContainer>
            <Card>
        ...
        {dataChartOne != {} && (
          <>
            <ChartTitle>Sales Revenue Overview</ChartTitle>
            <StyledBarChart
              width={1000}
              height={400}
              data={dataChartOne}
